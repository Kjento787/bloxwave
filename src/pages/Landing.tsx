...
import { Eye, EyeOff, Mail, Lock, Play, Film, Tv, Star } from "lucide-react";
import { z } from "zod";
    ...
    <PageTransition>
      <div className="min-h-screen bg-background relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="grid grid-cols-4 md:grid-cols-6 gap-0.5 h-full opacity-[0.08]">
            {bgPosters.map((movie) => (
        ...
        <div className="relative z-10 min-h-screen flex flex-col lg:flex-row items-center justify-center px-4 py-12 gap-12 lg:gap-20 max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.p custom={2} variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-8">
              Unlimited movies and TV shows. Discover, watch, and explore — all in one place.
            </motion.p>

            {/* Feature highlights */}
            <motion.div custom={3} variants={fadeUp} className="flex flex-wrap justify-center lg:justify-start gap-6 text-sm text-muted-foreground">
              {[
                { icon: Film, label: "Thousands of Movies" },
                { icon: Tv, label: "TV Series" },
                { icon: Star, label: "Curated Collections" },
              ].map(({ icon: Icon, label }) => (
          ...
          >
            <div className="bg-card/80 backdrop-blur-2xl rounded-2xl p-8 shadow-card border border-border/40 relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      className="pl-10 bg-secondary/50 border-border focus:border-primary focus:ring-1 focus:ring-primary/20 h-12 rounded-xl"
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      className="pl-10 pr-10 bg-secondary/50 border-border focus:border-primary focus:ring-1 focus:ring-primary/20 h-12 rounded-xl"
                    />
                    <button
                      type="button"
                ...
                <Button
                  type="submit"
                  className="w-full h-12 text-base font-bold bg-primary text-primary-foreground hover:bg-primary/90 rounded-xl shadow-glow transition-shadow hover:shadow-[0_0_40px_hsl(40_65%_55%/0.3)]"
                  disabled={loading}
                >
                  {loading ? (
